...
model = dict(
    ...
    pretrained=None,
    reader=dict(
        type="DynamicVoxelVFE",
        model_cfg=SimpleNamespace(
            WITH_DISTANCE=False,
            USE_ABSLOTE_XYZ=True,
            USE_NORM=True,
            NUM_FILTERS=[ 192, 192 ], # channel
        ),
        num_point_features=5,
        voxel_size=[0.23, 0.23, 0.25],                               # [ 0.32, 0.32, 0.1875]
        grid_size=[468, 468, 32],
        point_cloud_range=[-53.82, -53.82, -5.0, 53.83, 53.82, 3.0], # [-74.88, -74.88, -2, 74.88, 74.88, 4.0]
    ...
    backbone=dict(
        ...
        model_cfg=SimpleNamespace(
            INPUT_LAYER=SimpleNamespace(
                ...
                d_model= [192, 192, 192, 192], # channel
...
assigner = dict(
    ...
    pc_range=[-53.82, -53.82, -5.0, 53.83, 53.82, 3.0],
...
test_cfg = dict(
    ...
    pc_range=[-53.82, -53.82],
    out_size_factor=1,
    voxel_size=[0.23, 0.23],
    obj_num= 500,
)
...
voxel_generator = dict(
    range=[-53.82, -53.82, -5.0, 53.83, 53.82, 3.0],
    voxel_size=[0.23, 0.23, 0.25],
